...
view model =
    { title = "Filmographio"
    , body =
        [ CDN.stylesheet -- creates a link tag with the Bootstrap CSS
          , div []
            [ menu model
            , mainContent model
            , modal model
...
menu model =
    Navbar.config NavMsg
        ...
        |> Navbar.container
        |> Navbar.brand [ href "#" ] [ text "Filmographio" ]
        |> Navbar.items
...
pageActors : Model -> List (Html Msg)
pageActors model =
    [ h2 [] [ text "Actors" ]
    , Button.button
        [ Button.success
...
pageMovies : Model -> List (Html Msg)
pageMovies model =
    [ h1 [] [ text "Movies" ]
    , Listgroup.ul
